 ...
 * @property string $data_resource_content
 ...
 */
class OtherDataResource extends Model
{
     ...
     * @var string
     */
    protected $table = 'other_data_resource';
     ...
     * @var array
     */
    protected $fillable = ['data_resource_content', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
