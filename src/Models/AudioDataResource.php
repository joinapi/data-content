 ...
 */
class AudioDataResource extends Model
{
     ...
     * @var string
     */
    protected $table = 'audio_data_resource';
     ...
     * @var array
     */
    protected $fillable = ['audio_data', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
