...
class DataResourceType extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\DataResourceTypeAttr', 'data_resource_type_id', 'data_resource_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\DataResource', 'data_resource_type_id', 'data_resource_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Content\DataResourceType', 'parent_type_id', 'data_resource_type_id');
    }
}
