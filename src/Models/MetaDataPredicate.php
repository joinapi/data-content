...
class MetaDataPredicate extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\ContentMetaData', 'meta_data_predicate_id', 'meta_data_predicate_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\DataResourceMetaData', 'meta_data_predicate_id', 'meta_data_predicate_id');
    }
}
