 ...
 */
class VideoDataResource extends Model
{
     ...
     * @var string
     */
    protected $table = 'video_data_resource';
     ...
     * @var array
     */
    protected $fillable = ['video_data', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
