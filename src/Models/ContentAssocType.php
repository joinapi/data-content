 ...
 */
class ContentAssocType extends Model
{
     ...
     * @var string
     */
    protected $table = 'content_assoc_type';
     ...
     * @var string
     */
    protected $primaryKey = 'content_assoc_type_id';
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\ContentAssoc', 'content_assoc_type_id', 'content_assoc_type_id');
    }
}
