...
class SurveyResponse extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\GiftCardFulfillment', 'survey_response_id', 'survey_response_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\DataResource', 'survey_response_id', 'survey_response_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\ShoppingListItemSurvey', 'survey_response_id', 'survey_response_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\SurveyResponseAnswer', 'survey_response_id', 'survey_response_id');
    }
}
