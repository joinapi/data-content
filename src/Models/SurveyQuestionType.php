...
class SurveyQuestionType extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'survey_question_type_id';
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\SurveyQuestion', 'survey_question_type_id', 'survey_question_type_id');
    }
}
