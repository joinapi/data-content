...
class CharacterSet extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\Content', 'character_set_id', 'character_set_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Content\DataResource', 'character_set_id', 'character_set_id');
    }
}
