...
class ContentPurposeType extends Model
{
    ...
    {
        return $this->hasMany('\DataResourcePurpose', 'content_purpose_type_id', 'content_purpose_type_id');
    }
    ...
    {
        return $this->hasMany('\ContentPurpose', 'content_purpose_type_id', 'content_purpose_type_id');
    }
    ...
    {
        return $this->hasMany('\ContentPurposeOperation', 'content_purpose_type_id', 'content_purpose_type_id');
    }
}
