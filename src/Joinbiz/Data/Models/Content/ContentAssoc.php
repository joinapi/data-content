...
class ContentAssoc extends Model
{
    ...
    {
        return $this->belongsTo('\ContentAssocPredicate', 'content_assoc_predicate_id', 'content_assoc_predicate_id');
    }
    ...
    {
        return $this->belongsTo('\Content', 'content_id_to', 'content_id');
    }
    ...
    {
        return $this->belongsTo('\ContentAssocType', 'content_assoc_type_id', 'content_assoc_type_id');
    }
}
